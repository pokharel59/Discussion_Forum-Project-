...
class ResendMessage(models.Model):
    ...
    requester = models.ForeignKey(User, on_delete=models.CASCADE, related_name='resend_requests')
    sender = models.ForeignKey(User, on_delete=models.CASCADE, related_name='resent_messages')
